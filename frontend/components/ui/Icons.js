/**
 * EnergyShield Command Center SVG Icons (Zero external dependency overhead)
 */
...
export function AnchorIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} {...props}>
      <circle cx="12" cy="5" r="3" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v13m-7-5a7 7 0 0014 0M5 16H3m18 0h-2" />
    </svg>
  );
}
...
export function ActivityIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12h3.75l2.25-6 4.5 12 2.25-6h6.75" />
    </svg>
  );
}
...
export function NavigationIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} {...props}>
...
export function FilterIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 4.5h18m-15 5.25h12m-9 5.25h6" />
    </svg>
  );
}
...
export function ChevronUpIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} {...props}>
